...
def time_display_converter(seconds):
    hours = seconds // 3600   #calculating how many hours there will be and rounds result *down* to the nearest lower number
    minutes = (seconds % 3600) // 60 # (seconds % 3600) = what remains left after dividing/creating hours
    seconds = seconds % 60 #reminder after division (%) by 60
...
def click_stop():
    global current_state
    current_state = False
    root.after(1000, recreate_entry)
